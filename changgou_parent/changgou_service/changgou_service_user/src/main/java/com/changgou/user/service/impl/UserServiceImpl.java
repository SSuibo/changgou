...
public class UserServiceImpl implements UserService {
    ...
    public int updateUserPoints(Task task) {
        ...
        //1.从task中获取相关数据
        Map taskMap = JSON.parseObject(task.getRequestBody(), Map.class);
        String username = (String) taskMap.get("username");
        String orderId = (String) taskMap.get("orderId");
        int point = (int) taskMap.get("point");
        ...
        //3.将当前任务存到redis中,键是task的id,值随意,最好设置过期时间
